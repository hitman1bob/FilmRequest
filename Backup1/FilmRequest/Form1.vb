...
#Region " Variables "
    Dim sPromsLocation As String = ConfigurationSettings.AppSettings("ProMSLocation")
    Dim strSMTPServer = ConfigurationSettings.AppSettings("SMTPServer")
    Dim strSender As String = ConfigurationSettings.AppSettings("Sender")
    Dim strRecipients As String = ConfigurationSettings.AppSettings("Recipients")
#End Region

    Private Sub btnFindInfo_Click( _
    ...
    Handles btnFindIt.Click
        ...
        Else
            ...
            SendHTMLMail(ToolNo, Cust, PartNo, Rev, WoNo, ScaleX, ScaleY, XDim, YDim, OpInit, Comments)
            ResetForm()
        End If
    ...
    ByVal Comments As String)
        ...
        Try
            ...
            oMsg.From = strSender
            oMsg.To = strRecipients
            oMsg.Subject = ToolNo + " " + WoNo + " Scaled Film Request"

            ' SEND IN HTML FORMAT (comment this line to send plain text).
            oMsg.BodyFormat = MailFormat.Html

            ' HTML Body (remove HTML tags for plain text).
            oMsg.Body = "<!DOCTYPE html PUBLIC " & "-//W3C//DTD HTML 4.01 Transitional//EN" & _
